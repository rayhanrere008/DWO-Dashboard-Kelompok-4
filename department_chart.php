                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="department_chart.php">Department Chart</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <!-- Akhir Jumlah Department -->

                            <!-- Awal Jumlah GroupName -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Jumlah Group Pada Department</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT GroupName) AS jumlah_grup
                                                FROM department";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                            <?php
                                                ...
                                                $query = "SELECT d.GroupName, COUNT(DISTINCT fh.EmployeeID) as total
                                                FROM department d  
                                                JOIN fakta_humanresource fh ON d.DepartmentID = fh.DepartmentID 
                                                group by GroupName";
                                                ...
                                                <div class="highcharts">
                                                    ...
                                                    Highcharts.chart('container', {
                                                        ...
                                                        title: {
                                                            text: 'Jumlah Karyawan per Group Name Departemen'
                                                        },
                                                        xAxis: {
                                                            type: 'category'
                                                        },
                                                        ...
                                                        series: [{
                                                            name: 'Total Employee di Group Name',
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Jumlah Department Yang Memiliki Pay Frequency 1 dan 2</h6>
                                    </div>
                                    <div class="card-body">
                                            <?php
                                                $host       = "localhost";
                                                ...
                                                // Mengambil data dari database
                                                $query = "SELECT ep.PayFrequency, COUNT(DISTINCT fh.DepartmentID) as total
                                                from employeepayhistory ep 
                                                JOIN fakta_humanresource fh ON ep.EmployeeID = fh.EmployeeID
                                                join department d on fh.DepartmentID = d.DepartmentID
                                                ...
                                                <div class="highcharts">
                                                    ...
                                                    Highcharts.chart('container1', {
                                                        ...
                                                        title: {
                                                            text: 'Jumlah Department per Pay Frequency'
                                                        },
                                                        xAxis: {
                                                            type: 'category'
                                                        },
                                                        ...
                                                        series: [{
                                                            name: 'Total Department per PayFrequency',
                                                            data: <?php echo json_encode($data); ?>,
                                                            dataLabels: {
                                                                enabled: true,
                                                                format: '{point.y}'

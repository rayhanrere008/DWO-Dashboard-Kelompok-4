                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="employee_chart.php">Employee Chart</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <!-- Akhir Jumlah Employee -->

                            <!-- Awal Jumlah Employee "M" -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Jumlah Employee Bergender Laki-laki</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(EmployeeID)) as employee_male FROM employee WHERE Gender = 'M'";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['employee_male'],0,".",",");
                                                    }
                                                ?>
                                                </div>
                                            </div>
                            ...
                            <!-- Akhir Jumlah Employee "M" -->

                            <!-- Awal Jumlah Employee "F" -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Jumlah Employee Bergender Perempuan</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(EmployeeID)) as employee_female FROM employee WHERE Gender = 'F'";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['employee_female'],0,".",",");
                                                    }
                                                ?>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Jumlah Employee Per Departemen </h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $query = "SELECT d.Name, COUNT(DISTINCT e.EmployeeID) as total
                                            FROM department d
                                            JOIN employeedepartmenthistory e ON d.DepartmentID = e.DepartmentID
                                            group by Name ";
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Jumlah Karyawan yang masuk per tahun</h6>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                            $host       = "localhost";
                                            ...
                                            // Mengambil data dari database
                                            $query = "SELECT t.tahun, COUNT(DISTINCT fh.EmployeeID) as total
                                            FROM time t 
                                            JOIN fakta_humanresource fh ON t.time_id = fh.time_id
                                            group by tahun";
                                            $result = mysqli_query($mysqli, $query);
                                        ...
                                        <div class="highcharts">
                                            ...
                                            <script>
                                                ...
                                                Highcharts.chart('container1', {
                                                    ...
                                                    title: {
                                                        text: 'Jumlah Karyawan Yang Masuk Perusahaan Per Tahun'
                                                    },
                                                    xAxis: {
                                                        type: 'category'
                                                    },
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Jumlah Karyawan yang memiliki Pay Frequency 1 dan 2</h6>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                            $host       = "localhost";
                                            ...
                                            // Mengambil data dari database
                                            $query = "SELECT ep.PayFrequency, COUNT(DISTINCT fh.EmployeeID) as total
                                            from employeepayhistory ep 
                                            JOIN fakta_humanresource fh ON ep.EmployeeID = fh.EmployeeID 
                                        ...
                                        <div class="highcharts">
                                            ...
                                            <script>
                                                ...
                                                Highcharts.chart('container2', {
                                                    ...
                                                    title: {
                                                        text: 'Jumlah Karyawan Yang Memiliki Pay Frequency'
                                                    },
                                                    xAxis: {
                                                        type: 'category'
                                                    },

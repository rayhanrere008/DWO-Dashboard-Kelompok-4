            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header show">Mondrian DW</h6>
                            <a class="collapse-item" href="mondrian_sales.php">Sales</a>
                            <a class="collapse-item active" href="mondrian_human_resource.php">Human Resource</a>
                        </div>
                    </div>
                </li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between ">
                            <h1 class="h3 mb-0 text-gray-800">Mondrian Human Resource</h1>
                        </div>
                        <!-- Content Human Resource -->
                        <!-- Mondrian -->
                        <div class="row">
                            <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=dwhuman_resources" style="height:300px; width:100%; border:none; align-content:center"> </iframe>
                        </div>
                    </div>
                </div>
                <!-- End of Main Content -->

                ...
                <li class="nav-item">
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="mondrian_sales.php">Sales</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h3 mb-0 text-gray-800">Mondrian Sales</h1>
                        </div>
                        <!-- Content Sales -->
                        <!-- Mondrian -->
                        <div class="row">
                            <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=dwsales" style="height:300px; width:100%; border:none; align-content:center"> </iframe>
                        </div>
                    </div>
                </div>
                <!-- End of Main Content -->

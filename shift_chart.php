                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="shift_chart.php">Shift Chart</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <!-- Awal Jumlah Employee Bershift "Day" -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Jumlah Employee yang Bershift Day</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(EmployeeID)) as employee_day FROM employeedepartmenthistory WHERE Name = 'Day'";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                            ...
                            <!-- Akhir Jumlah Employee Bershift "Day" -->

                            <!-- Awal Jumlah Employee Bershift "Evening" -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Jumlah Employee yang Bershift Evening</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(EmployeeID)) as employee_evening FROM employeedepartmenthistory WHERE Name = 'Evening'";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['employee_evening'],0,".",",");
                                                    }
                                                ?>
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                            <i class="fas fa-cloud-moon fa-2x text-gray-300"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!-- Akhir Jumlah Employee Bershift "Evening" -->

                            <!-- Awal Jumlah Employee Bershift "Night" -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Jumlah Employee yang Bershift Night</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(EmployeeID)) as employee_night FROM employeedepartmenthistory WHERE Name = 'Night'";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['employee_night'],0,".",",");
                                                    }
                                                ?>
                                                </div>
                                            </div>
                            ...
                            <!-- Akhir Jumlah Employee Bershift "Night" -->
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Jumlah Employee Yang Memiliki Shift Day, Evening, dan Night</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <?php
                                                ...
                                                $query = "SELECT ed.Name, COUNT(DISTINCT fh.EmployeeID) as total
                                                FROM employeedepartmenthistory ed  
                                                JOIN fakta_humanresource fh ON ed.ShiftID = fh.ShiftID 
                                                group by Name";
                                                ...
                                                <div class="highcharts">
                                                    ...
                                                    Highcharts.chart('container', {
                                                        ...
                                                        title: {
                                                            text: 'Jumlah Karyawan per Shift'
                                                        },
                                                        xAxis: {
                                                            type: 'category'
                                                        },
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Jumlah Department Yang Memiliki Shift Day, Evening, dan Night</h6>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                                $host       = "localhost";
                                                ...
                                                // Mengambil data dari database
                                                $query = "SELECT e.Name, COUNT(DISTINCT fh.DepartmentID) as total
                                                FROM employeedepartmenthistory e  
                                                JOIN fakta_humanresource fh ON e.DepartmentID = fh.DepartmentID 
                                                group by Name";
                                                $result = mysqli_query($mysqli, $query);
                                                ...
                                                <div class="highcharts">
                                                    ...
                                                    Highcharts.chart('container1', {
                                                        ...
                                                        title: {
                                                            text: 'Jumlah Departemen per Shift'
                                                        },
                                                        xAxis: {
                                                            type: 'category'
                                                        },
                                                        ...
                                                        series: [{
                                                            name: 'Total Departemen per Shift',
                                                            data: <?php echo json_encode($data); ?>,
                                                            dataLabels: {
                                                                enabled: true,
                                                                format: '{point.y}'
